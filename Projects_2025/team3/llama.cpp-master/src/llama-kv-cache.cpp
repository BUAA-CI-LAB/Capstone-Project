...
llama_kv_cache::llama_kv_cache(
    ...
    for (uint32_t il = 0; il < hparams.n_layer; il++) {
        ...
        ggml_tensor * k = ggml_new_tensor_3d(ctx, GGML_TYPE_Q8_0, n_embd_k_gqa, kv_size, n_stream);
        ggml_tensor * v = ggml_new_tensor_3d(ctx, GGML_TYPE_Q8_0, n_embd_v_gqa, kv_size, n_stream);
