...
inline static void ggml_vec_sqr_sum_f32(const int n, float * s, const float * x) {
    float sumf = 0.0;
#if defined(GGML_USE_ACCELERATE)
#elif defined(GGML_SIMD)
#if defined(__ARM_FEATURE_SVE)
...
inline static void ggml_vec_scale_cpy_f32(const int n, float * y, const float * x, const float   v) {
#if defined(GGML_USE_ACCELERATE)
#elif defined(GGML_SIMD)
#if defined(__ARM_FEATURE_SVE)
#elif defined(__riscv_v_intrinsic)
